...
function getBackendUrl(): string {
    if (typeof window !== 'undefined') {
        ...
        return process.env.NEXT_PUBLIC_API_URL || 'https://realestatepricebackend-production.up.railway.app';
    }
    return 'https://realestatepricebackend-production.up.railway.app';
}
